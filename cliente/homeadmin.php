...
<body>
    ...
    <nav id="main_nav" class="navbar navbar-expand-lg navbar-light bg-white shadow">
        <div class="container d-flex justify-content-between align-items-center">
            <a class="navbar-brand h1" href="homeadmin.php">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="navbar-toggler-success">
                <div class="flex-fill mx-xl-5 mb-2">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-xl-5 text-center text-dark">
                        <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3" href="homeadmin.php">Inicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3" href="logout.php">Cerrar Sesion</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3" href="reset-passworda.php">Cambiar Contraseña</a>
                    </ul>
                </div>
                <div class="navbar align-self-center d-flex">
                    <a class="nav-link" href="reset-passworda.php"><i class='bx bx-cog bx-sm text-primary'></i></a>
    ...
    <ul class="breadcrumb">
        <li><a class="text-primary " href="homeadmin.php">Inicio</a></li>
      </ul>
    <!-- Start Banner Hero -->
    <div class="banner-wrapper bg-light">
        <div id="index_banner2" class="banner-vertical-center-index container-fluid pt-5">
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                <h1 class="banner-heading h1 text-secondary display-3 mb-0 pb-5 mx-0 px-0 light-300 typo-space-line">
                                    Hola <strong>Administrador</strong> Bienvenido
                                  <br>A Mi Sitio
                              </h1>
        ...
        <div class="container py-5">
            <div class="row d-flex justify-content-center text-center">
                ...
                <div class="col-lg-3 col-12 pt-4">
                    <a href="reset-passworda.php" class="btn btn-primary rounded-pill btn-block shadow px-4 py-2">Cambiar Contrasenia</a>
                </div>
            </div>
        </div>
    </section>
